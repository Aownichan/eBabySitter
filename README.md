we are using react native for the frontend,for that you need to downlaod node.js first ( I downloaded v21.7.3) and then install react native by writing "npm install -g react-native-cli" in the command line.
